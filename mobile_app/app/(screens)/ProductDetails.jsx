    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <View style={styles.imageContainer}>
          <Image style={styles.productImage} source={{ uri: product.image_url }} />
        </View>
        <View style={styles.contentContainer}>
          <Text style={styles.productName}>{product.name}</Text>
          {product.price != null ? <Text style={styles.price}>NPR {product.price}</Text> : <Text style={styles.price}>Price : N/A</Text>}
          
          {product.rating != null ? <Text style={styles.rating}>Rating {product.rating}</Text> : <Text style={styles.price}>Rating : N/A</Text>}
          
          {product.gender != null ? <Text style={styles.otherInfoText}>For: {product.gender}</Text> : <Text style = {styles.price}>.</Text>}
         
          <Text style={styles.description}>{dummydescription}</Text>
          <Text style={styles.otherInfoText}>Category : {product.category}</Text>
